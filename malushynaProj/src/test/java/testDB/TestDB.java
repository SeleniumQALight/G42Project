...
//        database.changeTable("INSERT INTO seleniumTable VALUES (55, 'g42MalushynaTest', 'Pass')");

        dataFromSeleniumTable =
                database.selectTableAsMap("select * from seleniumTable where login = 'g42MalushynaTest'");
        logger.info(dataFromSeleniumTable);

        UtilsForDB utilsForDB = new UtilsForDB();
        logger.info(utilsForDB.getPassForLogin("g42MalushynaTest"));
