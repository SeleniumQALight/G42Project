...
public class MySQL_Database {
    private static ConfigProperties configProperties = ConfigFactory.create(ConfigProperties.class); // configProperties - переменная которая работает с проперти файликом
