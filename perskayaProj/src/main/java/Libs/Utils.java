...
import org.apache.commons.io.FileUtils; // скопировать депенденси из телеграма в poom файл
...
public class Utils {
     ...
     * @param second
     */
    public static void waitABit(int second){ // м-д обертка , во время которого программа ничего не делает
        try {
            Thread.sleep(second);
     ...
     * @return
     */
    public static String getDateAndTimeFormated(){ // м-д получения даты
     ...
     * @return
     */
    public static String getDateAndTime(String format){  // м-д
